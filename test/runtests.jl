...
@testset "Coriolis" begin
    ...
    for i = 1:9
        ...
        @test C ≈ C_from_python[i, :] atol=1e-8
    end

    for i = 1:9
        @test KinovaGen3.coriolis(q[i, :], qp[i, :]) ≈ C_from_python[i, :] atol=1e-8
    end
end
...
@testset "Gravity" begin
    ...
    # Coriolis term calculated for each test configuration using pyKinovaGen3
    G_from_python = SA[4.67825214e-17  2.97799707e+00 -2.14540368e-01  5.32302544e+00 6.45436860e-01  5.07571796e-01 -4.18264205e-02;
                      -2.46671477e-16 -1.04473551e+01 -1.20878208e+00 -1.61480199e-01 1.45186669e-01  9.58798670e-01 -4.05470242e-02;
                      -1.32054299e-15 -2.08431606e+01 -6.17320814e-01  3.86850553e+00 4.75232455e-01  6.36831223e-01 -4.59644663e-02;
                      -1.12703347e-16  7.80212268e+00 -2.38050594e-01 -5.50612995e-01 -2.21625272e-01 -7.42175169e-01  4.26361901e-02;
                      -1.74477540e-15 -1.22353130e+01 -1.55880856e+00  3.60005072e+00 -5.59960867e-01 -4.78977550e-01  9.11662763e-03;
                      -1.82877129e-16 -1.71051909e+01 -2.18931516e+00  1.04804067e+00 -5.12141546e-01  5.65083219e-01 -3.86410614e-02;
                      -8.82488472e-16  1.66966355e+01  3.84858195e+00 -8.46659889e-01 -4.36292243e-01  5.44721421e-01  3.66174914e-02;
                      -4.76331127e-16  1.59055984e+01 -2.94058614e+00 -5.57906455e+00 3.76861429e-01  3.30400897e-01 -3.65874388e-02;
                      -3.00896672e-16 -1.21239421e+01  4.73414784e+00 -1.35861208e+00 -6.75494406e-01  3.57017927e-01  5.42721103e-02]

    G = zeros(MVector{7})

    for i = 1:9
        KinovaGen3.gravity!(q[i, :], G)
        @test G ≈ G_from_python[i, :] atol=1e-7
    end

    for i = 1:9
        @test KinovaGen3.gravity(q[i, :]) ≈ G_from_python[i, :] atol=1e-7
    end
end